<xsl:stylesheet version="1.1"
	...
	<xsl:template match="/">
		<fo:root>
			...
			<fo:page-sequence initial-page-number="1"
				language="en" country="us" master-reference="rest">
				<fo:static-content flow-name="xsl-region-before">
					<fo:block-container position="absolute"
						font-weight="bold" color="#2580BC" line-height="5mm"
						font-family="Arial, Helvetica, Gyosho, Trado, sans-serif"
						padding-top="1cm" font-size="18pt" text-align="left"
						margin-left="2mm">

						<fo:block text-align="{ReportData/TitleAlign}"
							padding-top="5mm">
							<xsl:value-of select="ReportData/ReportTitle"
								text-align="center" />
						</fo:block>
						<fo:block text-align="{ReportData/TitleAlign}"
							margin-right="0mm" font-weight="bold"
							font-family="Arial, Helvetica, Gyosho, Trado, sans-serif"
							color="#999999" padding-bottom="1%" font-size="8pt">
							<xsl:choose>
								<xsl:when
									test="(ReportData/BuildSystemDetailBy)='manual'">
					...
					<xsl:if test="(ReportData/Logo)='show'">
						<fo:block-container position="absolute">
							<fo:block text-align="{ReportData/LogoAlign}"
								margin-right="4mm">
								<xsl:choose>
								...
								<fo:table-row>
									...
									<fo:table-cell>
										<fo:block font-weight="normal"
											...
											generated by
											<fo:basic-link
												external-destination="http://uttesh.github.io/pdfngreport/"
												show-destination="new">pdfngreport </fo:basic-link>
	...
	<xsl:template match="ReportData">
		...
		<xsl:for-each select="Table">
						...
						<fo:table-row>
							<fo:table-cell>
								<fo:block font-weight="bold"
									font-family="Arial, Helvetica, Gyosho, Trado, sans-serif"
									padding-bottom="1.3%" font-size="10pt" text-align="left"
									color="#fff" margin-left="2mm">
									<fo:external-graphic
										content-height="scale-to-fit" height="15pt" margin-right="2mm"
										content-width="25pt" src="{TableHeaderIcon}" />
			...
			<fo:table space-after="4pt" table-layout="fixed"
				width="98.1%" table-omit-header-at-break="false">
				...
				<fo:table-header>
					<fo:table-row>
						<xsl:apply-templates
							select="ColumnHeaders/ColumnHeader" />
					</fo:table-row>
				</fo:table-header>
				<fo:table-body>
				...
				<fo:block font-size="10pt" margin-top="10pt">
					<xsl:choose>
						<xsl:when test="OSName='w'">
							<fo:external-graphic
								src="url(file:/{ReportLocation}/chart.png)"
								content-height="scale-to-fit" scaling="non-uniform" />
						</xsl:when>
						<xsl:otherwise>
							<fo:external-graphic
								src="{ReportLocation}/chart.png" content-height="scale-to-fit"
								scaling="non-uniform" />
						</xsl:otherwise>
					</xsl:choose>
				</fo:block>
		...
		<xsl:if test="ExceptionPage = 'show'">
						...
						<fo:table-row>
							<fo:table-cell>
								<fo:block font-weight="bold"
									...
									<fo:external-graphic
										content-height="scale-to-fit" height="15pt" margin-right="2mm"
										content-width="25pt" src="{ExceptionIcon}" />
									Exception Summary
								</fo:block>
							</fo:table-cell>
						</fo:table-row>
			...
			<xsl:for-each select="ExceptionMeta">
				<fo:block id="{ErrorCode}"
					font-family="Arial, Helvetica, Gyosho, Trado, sans-serif"
					padding-top="1.5%" padding-bottom="1.3%" font-size="10pt"
					text-align="left" margin-left=".2mm" margin-right="3.6mm"
					border=".5pt" border-style="solid" border-color="black"
					padding="1mm">
					<fo:inline border-after-width=".5pt" color="red"
	...
	<xsl:template match="ColumnHeader">
		<fo:table-cell border-bottom-color="black"
			background-color="{ColorCode}" border-top-color="black"
			border-right-color="black" display-align="center" padding-top="1.5%"
			padding-bottom="1.3%" border-bottom-width=".5pt"
			border-top-width=".5pt" border-top-style="solid"
			border-bottom-style="solid">
			<fo:block color="white"
				font-family="Arial, Helvetica, Gyosho, Trado, sans-serif"
				font-size="8pt" vertical-align="bottom" text-align="left"
				font-weight="bold" margin-left="2mm">
